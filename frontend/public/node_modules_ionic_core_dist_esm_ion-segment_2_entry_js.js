(self["webpackChunkOFGC"] = self["webpackChunkOFGC"] || []).push([["node_modules_ionic_core_dist_esm_ion-segment_2_entry_js"],{
...
const Segment = class {
   ...
   */
  addRipple(detail) {
    const useRippleEffect = _ionic_global_0ebe321c_js__WEBPACK_IMPORTED_MODULE_1__.c.getBoolean('animated', true) && _ionic_global_0ebe321c_js__WEBPACK_IMPORTED_MODULE_1__.c.getBoolean('rippleEffect', true);
    if (!useRippleEffect) {
      return;
    }
    const buttons = this.getButtons();
    ...
    const { x, y } = (0,_helpers_6e1e5b65_js__WEBPACK_IMPORTED_MODULE_2__.p)(detail.event);
  ...
  **/
  ...
  render() {
    ...
    return ((0,_index_b3eecb14_js__WEBPACK_IMPORTED_MODULE_0__.h)(_index_b3eecb14_js__WEBPACK_IMPORTED_MODULE_0__.H, { role: "tablist", onClick: this.onClick, class: (0,_theme_a24ff1ad_js__WEBPACK_IMPORTED_MODULE_4__.c)(this.color, {
        [mode]: true,
...
const SegmentButton = class {
  ...
  connectedCallback() {
    ...
    if (segmentEl) {
      this.updateState();
      (0,_helpers_6e1e5b65_js__WEBPACK_IMPORTED_MODULE_2__.a)(segmentEl, 'ionSelect', this.updateState);
      (0,_helpers_6e1e5b65_js__WEBPACK_IMPORTED_MODULE_2__.a)(segmentEl, 'ionStyle', this.updateStyle);
    }
  }
  disconnectedCallback() {
    const segmentEl = this.segmentEl;
    if (segmentEl) {
      (0,_helpers_6e1e5b65_js__WEBPACK_IMPORTED_MODULE_2__.b)(segmentEl, 'ionSelect', this.updateState);
      (0,_helpers_6e1e5b65_js__WEBPACK_IMPORTED_MODULE_2__.b)(segmentEl, 'ionStyle', this.updateStyle);
      this.segmentEl = null;
    }
  }
  get hasLabel() {
