(self["webpackChunkOFGC"] = self["webpackChunkOFGC"] || []).push([["node_modules_ionic_core_dist_esm_ion-back-button_entry_js"],{
...
const BackButton = class {
  constructor(hostRef) {
    ...
    this.onClick = async (ev) => {
      ...
      return (0,_theme_a24ff1ad_js__WEBPACK_IMPORTED_MODULE_4__.o)(this.defaultHref, ev, 'back', this.routerAnimation);
    };
  }
  componentWillLoad() {
    this.inheritedAttributes = (0,_helpers_6e1e5b65_js__WEBPACK_IMPORTED_MODULE_3__.i)(this.el, ['aria-label']);
    if (this.defaultHref === undefined) {
      this.defaultHref = _ionic_global_0ebe321c_js__WEBPACK_IMPORTED_MODULE_2__.c.get('backButtonDefaultHref');
    }
  }
  get backButtonIcon() {
    ...
    if ((0,_ionic_global_0ebe321c_js__WEBPACK_IMPORTED_MODULE_2__.b)(this) === 'ios') {
      ...
      return _ionic_global_0ebe321c_js__WEBPACK_IMPORTED_MODULE_2__.c.get('backButtonIcon', _index_e3f61316_js__WEBPACK_IMPORTED_MODULE_1__.c);
    }
    // default md back button icon
    return _ionic_global_0ebe321c_js__WEBPACK_IMPORTED_MODULE_2__.c.get('backButtonIcon', _index_e3f61316_js__WEBPACK_IMPORTED_MODULE_1__.a);
  }
  get backButtonText() {
    const defaultBackButtonText = (0,_ionic_global_0ebe321c_js__WEBPACK_IMPORTED_MODULE_2__.b)(this) === 'ios' ? 'Back' : null;
    return this.text != null ? this.text : _ionic_global_0ebe321c_js__WEBPACK_IMPORTED_MODULE_2__.c.get('backButtonText', defaultBackButtonText);
  }
  get hasIconOnly() {
  ...
  render() {
    ...
    return ((0,_index_b3eecb14_js__WEBPACK_IMPORTED_MODULE_0__.h)(_index_b3eecb14_js__WEBPACK_IMPORTED_MODULE_0__.H, { onClick: this.onClick, class: (0,_theme_a24ff1ad_js__WEBPACK_IMPORTED_MODULE_4__.c)(color, {
        [mode]: true,
        'button': true,
