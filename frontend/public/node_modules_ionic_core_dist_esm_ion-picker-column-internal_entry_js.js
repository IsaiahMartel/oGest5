(self["webpackChunkOFGC"] = self["webpackChunkOFGC"] || []).push([["node_modules_ionic_core_dist_esm_ion-picker-column-internal_entry_js"],{
...
const PickerColumnInternal = class {
  constructor(hostRef) {
    ...
    this.initializeScrollListener = () => {
      ...
      const scrollCallback = () => {
        (0,_helpers_6e1e5b65_js__WEBPACK_IMPORTED_MODULE_2__.r)(() => {
          if (timeout) {
  ...
  componentWillLoad() {
    const visibleCallback = (entries) => {
      ...
      if (ev.isIntersecting) {
         ...
         */
        const oldActive = (0,_helpers_6e1e5b65_js__WEBPACK_IMPORTED_MODULE_2__.g)(this.el).querySelector(`.${PICKER_COL_ACTIVE}`);
  ...
  get activeItem() {
    return (0,_helpers_6e1e5b65_js__WEBPACK_IMPORTED_MODULE_2__.g)(this.el).querySelector(`.picker-item[data-value="${this.value}"]`);
  }
  render() {
    const { items, color, isActive, numericInput } = this;
    const mode = (0,_ionic_global_0ebe321c_js__WEBPACK_IMPORTED_MODULE_1__.b)(this);
    return ((0,_index_b3eecb14_js__WEBPACK_IMPORTED_MODULE_0__.h)(_index_b3eecb14_js__WEBPACK_IMPORTED_MODULE_0__.H, { tabindex: 0, class: (0,_theme_a24ff1ad_js__WEBPACK_IMPORTED_MODULE_4__.c)(color, {
        [mode]: true,
