(self["webpackChunkOFGC"] = self["webpackChunkOFGC"] || []).push([["node_modules_ionic_core_dist_esm_ion-item-option_3_entry_js"],{
...
/* harmony import */ var _theme_a24ff1ad_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./theme-a24ff1ad.js */ 7853);
...
const ItemOption = class {
  ...
  render() {
    ...
    return ((0,_index_b3eecb14_js__WEBPACK_IMPORTED_MODULE_0__.h)(_index_b3eecb14_js__WEBPACK_IMPORTED_MODULE_0__.H, { onClick: this.onClick, class: (0,_theme_a24ff1ad_js__WEBPACK_IMPORTED_MODULE_2__.c)(this.color, {
        [mode]: true,
...
const ItemOptions = class {
  ...
  render() {
    const mode = (0,_ionic_global_0ebe321c_js__WEBPACK_IMPORTED_MODULE_1__.b)(this);
    const isEnd = (0,_helpers_6e1e5b65_js__WEBPACK_IMPORTED_MODULE_3__.n)(this.side);
...
const ItemSliding = class {
  ...
  async open(side) {
    ...
    side = (0,_helpers_6e1e5b65_js__WEBPACK_IMPORTED_MODULE_3__.n)(side) ? 'end' : 'start';
  ...
  async updateOptions() {
    ...
    for (let i = 0; i < options.length; i++) {
      ...
      const side = (0,_helpers_6e1e5b65_js__WEBPACK_IMPORTED_MODULE_3__.n)(option.side) ? 'end' : 'start';
      if (side === 'start') {
