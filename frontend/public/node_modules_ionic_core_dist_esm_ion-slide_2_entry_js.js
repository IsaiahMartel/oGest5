(self["webpackChunkOFGC"] = self["webpackChunkOFGC"] || []).push([["node_modules_ionic_core_dist_esm_ion-slide_2_entry_js"],{
...
const Slides = class {
  ...
  connectedCallback() {
    {
      ...
      (0,_helpers_6e1e5b65_js__WEBPACK_IMPORTED_MODULE_2__.c)(this.el, () => {
        this.initSwiper();
      });
    }
  }
  ...
  async initSwiper() {
    ...
    // init swiper core
    // @ts-ignore
    const { Swiper } = await __webpack_require__.e(/*! import() */ "node_modules_ionic_core_dist_esm_swiper_bundle-28080340_js").then(__webpack_require__.bind(__webpack_require__, /*! ./swiper.bundle-28080340.js */ 1518));
...
const waitForSlides = (el) => {
  return Promise.all(Array.from(el.querySelectorAll('ion-slide')).map(s => new Promise(resolve => (0,_helpers_6e1e5b65_js__WEBPACK_IMPORTED_MODULE_2__.c)(s, resolve))));
};
Slides.style = {
  ios: slidesIosCss,
  md: slidesMdCss
