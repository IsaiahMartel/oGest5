(self["webpackChunkOFGC"] = self["webpackChunkOFGC"] || []).push([["node_modules_ionic_core_dist_esm_ion-virtual-scroll_entry_js"],{
...
const VirtualScroll = class {
  ...
  updateCellHeight(cell, node) {
    ...
    if (node) {
      (0,_helpers_6e1e5b65_js__WEBPACK_IMPORTED_MODULE_1__.c)(node, update);
    }
    else {
      update();
    }
