(self["webpackChunkOFGC"] = self["webpackChunkOFGC"] || []).push([["node_modules_ionic_core_dist_esm_ion-textarea_entry_js"],{
...
const Textarea = class {
  ...
  componentWillLoad() {
    this.inheritedAttributes = (0,_helpers_6e1e5b65_js__WEBPACK_IMPORTED_MODULE_2__.i)(this.el, ['title']);
  }
  componentDidLoad() {
    (0,_helpers_6e1e5b65_js__WEBPACK_IMPORTED_MODULE_2__.r)(() => this.runAutoGrow());
  }
  runAutoGrow() {
    const nativeInput = this.nativeInput;
  ...
  render() {
    ...
    const label = (0,_helpers_6e1e5b65_js__WEBPACK_IMPORTED_MODULE_2__.j)(this.el);
    if (label) {
      label.id = labelId;
    }
    return ((0,_index_b3eecb14_js__WEBPACK_IMPORTED_MODULE_0__.h)(_index_b3eecb14_js__WEBPACK_IMPORTED_MODULE_0__.H, { "aria-disabled": this.disabled ? 'true' : null, class: (0,_theme_a24ff1ad_js__WEBPACK_IMPORTED_MODULE_3__.c)(this.color, {
        [mode]: true,
